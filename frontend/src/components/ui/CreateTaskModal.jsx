...
export default function CreateTaskModal({ projectId, projectMembers, onClose, onSave }) {
  ...
  const getInitialsLocal = (name) => getInitials(name)
    ...
    >
      <div className={styles.modal}>
        ...
        <form onSubmit={handleSubmit} className={styles.form} noValidate>
          <h2 id="modal-title" className={styles.title}>Créer une tâche</h2>
                        ...
                        <li key={userId} role="option" aria-selected={isSelected}>
                          ...
                          >
                            <div className={styles.assigneeAvatar} aria-hidden="true">
                              {getInitialsLocal(m.user?.name || m.name)}
                            </div>
